...
const pageData = {
  "who-we-are": {
    ...
    content:
      "We are a dedicated community of badminton enthusiasts committed to fostering excellence, diversity, and sportsmanship in East London and Greater London.",
    comingSoon: true,
  },
  "what-we-play": {
    title: "What We Play",
    ...
    content:
      "We focus on competitive badminton matches, training sessions, and tournaments designed for upper intermediate, advanced, and expert players.",
    comingSoon: true,
  },
  "why-we-play": {
    title: "Why We Play",
    ...
    content:
      "We play to promote physical fitness, mental well-being, community building, and the development of badminton as a prominent sport in London.",
    comingSoon: true,
  },
  "where-we-play": {
    title: "Where We Play",
    ...
    content:
      "We have multiple venues across East London and Greater London, with facilities that cater to our high-level training and competitive needs.",
    comingSoon: true,
  },
  "when-we-play": {
    title: "When We Play",
    ...
    content:
      "We have regular sessions throughout the week, with specific timings for different skill levels and activities.",
    comingSoon: true,
  },
  "how-we-play": {
    title: "How We Play",
    ...
    content:
      "We emphasize technical excellence, strategic thinking, fair play, and continuous improvement through structured training and competitive play.",
    comingSoon: true,
  },
};
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            {pageInfo.comingSoon ? (
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                <h2 className="text-gray-800 mb-6">{pageInfo.title}</h2>
